  ...
  })(
    {
      1: [
        function (require, module, exports) {
          /**
           * @preserve
           * Copyright 2015 Igor Bezkrovny https://github.com/darosh/image-ssim-js
          ...
          (function (ImageSSIM) {
            ...
            function compare(
              ...
              function iteration(
                ...
                var numerator =
                  (2 * averageLumaValue1 * averageLumaValue2 + c1) *
                  (2 * sigxy + c2);
                var denominator =
              ...
              function _iterate(
                ...
                for (var y = 0; y < height; y += windowSize) {
                  for (var x = 0; x < width; x += windowSize) {
                    ...
                    var lumaValues1 = _lumaValuesForWindow(
                        image1,
                        x,
                        y,
                        windowWidth,
